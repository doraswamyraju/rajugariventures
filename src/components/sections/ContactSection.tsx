          ...
          <div>
            ...
            <div className="space-y-16">
              <div className="flex items-center gap-10 group cursor-pointer" data-cursor="Visit Us">
                ...
                <div>
                  <p className="text-xs font-mono uppercase tracking-[0.5em] text-white/20 mb-3">Global Command</p>
                  <p className="text-3xl font-display font-bold uppercase">Hyderabad, India</p>
                </div>
              </div>
              <div className="flex items-center gap-10 group cursor-pointer" data-cursor="Email Us">
                <div className="w-24 h-24 rounded-3xl border border-white/10 flex items-center justify-center group-hover:bg-brand-orange group-hover:text-black transition-all duration-500">
                  <Mail className="w-10 h-10" />
                </div>
                <div>
                  <p className="text-xs font-mono uppercase tracking-[0.5em] text-white/20 mb-3">Direct Channel</p>
                  <p className="text-3xl font-display font-bold uppercase">hello@rv.agency</p>
                </div>
              </div>
            </div>
          </div>
